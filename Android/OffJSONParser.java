...
public class OffJSONParser {
    public static ArrayList<LinearLayout> offParse(String str, TableLayout mTableLayout, Context context, LinearLayout mLinearLayout, boolean isTablet, Resources r){
        ...
        try {
            ...
            for (int i=0; i<sections.length(); i++){
                ...
                LinearLayout.LayoutParams relParamLeft= new LinearLayout.LayoutParams(width/2, LinearLayout.LayoutParams.MATCH_PARENT,1);
                ...
                LinearLayout.LayoutParams relParamRight= new LinearLayout.LayoutParams(width/2, LinearLayout.LayoutParams.MATCH_PARENT,1);
